...
local t = Def.ActorFrame{
	...
	Def.ActorFrame{
		...
		LoadActor("_panel1")..{
			OnCommand=function(s) s:diffusealpha(0):addx(-27):sleep(0.3):sleep(0.833):linear(0.45):diffusealpha(1):addx(27):sleep(0):diffusealpha(0) end,
		...
		LoadActor("_panel.png")..{
			OnCommand=function(s) s:diffusealpha(0):sleep(1.583):diffusealpha(1) end,
